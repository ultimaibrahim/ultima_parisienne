...
// AVISOS_CACHE_TTL y AVISOS_CACHE_TS_KEY vienen de config.js
...
function rc(input, save = true){
  ...
  let tend = '—';
  if(ticket > 0) {
    if(ticket >= TICKET_UMBRALES.verde) tend = '<span style="color:#2e7d32;font-size:12px;">🟢 Alza</span>';
    else if(ticket >= TICKET_UMBRALES.amarillo) tend = '<span style="color:#b35a00;font-size:12px;">🟡 Estable</span>';
...
// ── ADMIN: CRUD Usuarios descartado por petición del cliente ─────────────────────────────────────
